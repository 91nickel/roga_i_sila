        ...
        <div class="work_area width_960">
            <div class="slider">
                <ul class="bxslider">
                    ...
                    <li>
                        <div class="banner">
                            <img src="/include/images/test_slider_3.png'" alt=""
                                 title=""/>
                            <div class="banner_content">
            ...
            <section class="product_line">
                <figure class="product_item">
                    <div class="product_item_pict">
                        <a href="#">
                            <img src="/include/images/test_top_week_1.png"
                                 alt="BMW X3 2.0d" title="BMW X3 2.0d"/>
                        </a>
                    </div>
                    <figcaption>
                ...
                <figure class="product_item">
                    ...
                    <div class="product_item_pict">
                        <a href="#">
                            <img src="/include/images/test_top_week_2.png"
                                 alt="AUDI A6 3.0 TFSI" title="AUDI A6 3.0 TFSI"/>
                        </a>
                    </div>
                    <figcaption>
                ...
                <figure class="product_item">
                    ...
                    <div class="product_item_pict">
                        <a href="#">
                            <img src="/include/images/test_top_week_3.png"
                                 alt="Mercedes-Benz A200"
                ...
                <figure class="product_item">
                    <div class="product_item_pict">
                        <a href="#">
                            <img src="/include/images/no-image.jpg" alt="BMW Z4 sDrive35i"
            ...
            <section class="news_block inverse">
                ...
                <div>
                    <figure class="news_item">
                        <a href="#"><img src="/include/images/test_news_1.png" alt=""
                                         title=""/></a>
                    ...
                    <figure class="news_item">
                        <a href="#"><img src="/include/images/test_news_2.png" alt=""
                                         title=""/></a>
                        <figcaption class="news_item_description">
                            <h3><a href="#">Парадигма просветляет архетип</a></h3>
                            <div class="news_item_anons">
                    ...
                    <figure class="news_item">
                        <a href="#"><img src="/include/images/test_news_3.png" alt=""
                                         title=""/></a>
                        <figcaption class="news_item_description">
                            <h3><a href="#">Парадигма просветляет архетип</a></h3>
                            <div class="news_item_anons">
