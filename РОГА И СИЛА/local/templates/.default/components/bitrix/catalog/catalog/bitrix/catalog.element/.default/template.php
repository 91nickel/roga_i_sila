...
<figure class="product_detail">
    <figcaption>
        ...
        <div class="b-product-photo">
            ...
            <ul class="b-product-photo__list">
                ...
                <li class="b-product-photo__list-item">
                    <img class="b-product-photo__list-item__content" src="<?= $arResult['DETAIL_PICTURE']['SRC'] ?>" alt="<?= $arResult['DETAIL_PICTURE']['ALT'] ?>">
                </li>
                ...
                <li class="b-product-photo__list-item">
                    <img class="b-product-photo__list-item__content" src="<?= $pic['SRC'] ?>" alt="<?= $arResult['NAME'] ?>">
                </li>
                ...
                <li class="b-product-photo__list-item">
                    ...
                    <img class="b-product-photo__list-item__content" src="<?= NO_IMAGE_PATH ?>" alt="<?= $arResult['DETAIL_PICTURE']['ALT'] ?>">
            ...
            <div class="b-product-photo__thumbnail">
                <a data-slide-index="0" href="" class="b-product-photo__thumbnail-item">
                    <img class="b-product-photo__thumbnail-item__content" src="<?= $arResult['DETAIL_PICTURE']['SRC'] ?>" alt="<?= $arResult['DETAIL_PICTURE']['ALT'] ?>">
                </a>
                <? $i = 1 ?>
                ...
                <a data-slide-index="<?= $i ?>" href="" class="b-product-photo__thumbnail-item">
                    <img class="b-product-photo__thumbnail-item__content" src="<?= $pic['SRC'] ?>" alt="<?= $arResult['NAME'] ?>">
                </a>
                <? $i++ ?>
        ...
        <div class="price_block">
            ...
            <p class="current_price dark_grey"><b class="orange"><?= implode(' ', explode(' ', $arResult['PRICES']['BASE']['PRINT_DISCOUNT_VALUE'], -1)) ?></b> руб.</p>

            <? if ($arResult['CATALOG_QUANTITY'] > 1) : ?>
            <a class="buy_button inverse" href="<?= SITE_DIR . '?action=addToCart&element=' . $arResult['ID'] ?>"><?= $arResult['ORIGINAL_PARAMETERS']['MESS_BTN_ADD_TO_BASKET'] ?></a>

            <? else : ?>

            <p style="color:black;" class="inverse"><?= $arResult['ORIGINAL_PARAMETERS']['MESS_NOT_AVAILABLE'] ?></p>
