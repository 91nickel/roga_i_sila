...
class QSoftStoresList2 extends CBitrixComponent
{
    public $arNavParams;
    public $arNavigation;
    ...
    public function onPrepareComponentParams($arParams)
    {
        ...
        if ($arParams["DISPLAY_TOP_PAGER"] || $arParams["DISPLAY_BOTTOM_PAGER"]) {
            ...
            if ($this->arNavigation["PAGEN"] == 0 && $arParams["PAGER_DESC_NUMBERING_CACHE_TIME"] > 0)
    ...
    public function executeComponent()
    {
        ...
        if ($this->startResultCache(false, array(($arParams["CACHE_GROUPS"] === "N" ? false : $USER->GetGroups()), $this->bUSER_HAVE_ACCESS, $this->arNavigation, $this->arrFilter, $this->pagerParameters))) {
            ...
            $arResult["USER_HAVE_ACCESS"] = $this->bUSER_HAVE_ACCESS;
            ...
            while ($obElement = $rsElement->GetNextElement()) {
                ...
                if ($arParams['SHOW_MAP']) {
                    $placemarks[] = $this->getCoordinates($arItem["PROPERTIES"]['MAP'], $arItem["PROPERTIES"]['ADRESS']['VALUE']);
                }
                $i++;
            }
